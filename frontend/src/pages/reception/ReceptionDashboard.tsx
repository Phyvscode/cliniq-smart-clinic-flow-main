...
import { apiUpdateQueueStatus, apiGetPatients } from "@/lib/api";
...
const RegisterModal = ({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) => {
  ...
  // Debounced search as user types phone
  const handlePhoneChange = (value: string) => {
    ...
    timerRef.current = setTimeout(async () => {
      ...
      try {
        ...
        // If nothing found and user typed enough digits, offer new patient
